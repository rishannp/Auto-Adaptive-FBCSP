function [accuracy] = NAMdl(t,winlen,S9,window)
...
for i = 1:length(x)-2
    ...
    if i == 1
        ...
        [reBand,Wre,reTrain,reLabel] = fbcspRe(retr,2); % Training data using ltr bc the functions draws the right matrices
        ...
        [mdl.L] = trainQDA(lTrain, lLabel); % 5 Fold CV
        [mdl.R] = trainQDA(rTrain, rLabel);
        [mdl.Re] = trainQDA(reTrain, reLabel);
